...
public class CodingInterviewTask10_MergeOverlappingReservations {
    ...
    public static void main(String[] args) {
        System.out.println(format(solution3(new int[][]{{1, 3}, {2, 6}, {8, 10}, {15, 18}})));
        // Expected: [[1,6], [8,10], [15,18]]

        System.out.println(format(solution3(new int[][]{{1, 4}, {4, 5}})));
        // Expected: [[1,5]]

        System.out.println(format(solution3(new int[][]{{1, 4}, {2, 3}})));
        // Expected: [[1,4]]

        System.out.println(format(solution3(new int[][]{{5, 8}, {1, 3}})));
        // Expected: [[1,3], [5,8]]

        System.out.println(format(solution3(new int[][]{{1, 5}})));
        // Expected: [[1,5]]
    }
